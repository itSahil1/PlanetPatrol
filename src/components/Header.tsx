...
const clientId = "BMfVGxMxjQnuyuQfoWMPdyZ9-hrPt47NrqZN3fK6jg2HvfeE5A_LrXshrM49YMOitmNUTSDlYc6NVe1QJna8hcY";

const chainConfig = {
  chainNamespace: CHAIN_NAMESPACES.EIP155,
  chainId: "0x12c", // 300 in hex
  rpcTarget: "https://rpc.ankr.com/zksync_era_sepolia",
        ...
        <div className="flex items-center">
          ...
          <Link href="/" className="flex items-center">
            ...
            <div className="flex flex-col">
              <span className="font-bold text-base md:text-lg text-gray-800">PlanetPatrol</span>
